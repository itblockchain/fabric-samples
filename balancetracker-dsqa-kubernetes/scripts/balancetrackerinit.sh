...
peer chaincode query -C bcchannel -n bccc -c '{"Args":["GetQueryResult","{\"selector\":{\"tags\": {\"testTag1\": \"testTag1\"}}}"]}'
sleep 2

echo
echo

peer chaincode query -C bcchannel -n bccc -c '{"Args":["GetQueryResult","{\"selector\":{\"tags\": {\"flvTag1\": \"flvTagValue1\"}}}"]}'
sleep 2

echo
echo

peer chaincode query -C bcchannel -n bccc -c '{"Args":["GetQueryResult","{\"selector\":{\"quorum\":0,\"modelType\":\"Account\",  \"tags\": {\"testTag1\": \"testTag1\"}}}"]}'
sleep 2
