...
peer chaincode query -C bcchannel -n mycc -c '{"Args":["GetVersion"]}'
...
peer chaincode query -C bcchannel -n mycc -c '{"Args":["GetAuthor"]}'
...
peer chaincode query -C bcchannel -n mycc -c '{"Args":["GetDescription"]}'
...
peer chaincode query -C bcchannel -n mycc -c '{"Args":["GetServices"]}'
...
peer chaincode query -C bcchannel -n mycc -c '{"Args":["GetKey","testKey1"]}'
...
peer chaincode query -C bcchannel -n mycc -c '{"Args":["GetKey","testKey2"]}'
...
peer chaincode query -C bcchannel -n mycc -c '{"Args":["GetFlavor","testFlavor1"]}'
...
peer chaincode query -C bcchannel -n mycc -c '{"Args":["GetAccount","testAccount1"]}'
...
peer chaincode query -C bcchannel -n mycc -c '{"Args":["GetAccount","testAccount2"]}'
...
peer chaincode query -C bcchannel -n mycc -c '{"Args":["GetTransaction","transactionId1"]}'
...
peer chaincode query -C bcchannel -n mycc -c '{"Args":["GetAction","1001"]}'
...
peer chaincode query -C bcchannel -n mycc -c '{"Args":["GetSnapshot","1001_sh"]}'
...
peer chaincode query -C bcchannel -n mycc -c '{"Args":["GetToken","newTokenId1"]}'
...
peer chaincode query -C bcchannel -n mycc -c '{"Args":["GetToken","newTokenId2"]}'
...
peer chaincode query -C bcchannel -n mycc -c '{"Args":["GetToken","testTokenIdNew"]}'
...
peer chaincode query -C bcchannel -n mycc -c '{"Args":["GetQueryResult","{\"selector\": {\"accountId\":\"testAccount1\"}}"]}'
sleep 2

echo
echo

peer chaincode query -C bcchannel -n mycc -c '{"Args":["GetQueryResult","{\"selector\": {\"modelType\":\"Account\"}}"]}'
sleep 2
...
peer chaincode query -C bcchannel -n mycc -c '{"Args":["GetCertificate","testCert1"]}'
sleep 2
...
peer chaincode query -C bcchannel -n mycc -c '{"Args":["GetKey","testKey3"]}'
